...
class StudentsPerformance():
  ...
  def ConfusionMatrixMetrics(self):
    ...
    for classifier in self.confusion_matrix_metrics:
      for metric in self.confusion_matrix_metrics[classifier]:
        print (f"{metric} for {classifier}:" +
          str(self.confusion_matrix_metrics[classifier][metric]))
      print ()
